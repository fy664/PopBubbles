...
MainMenuState::MainMenuState() {
    ...
    m_titleText.setString("Pop Bubbles - 戳泡泡");
    ...
    // 新手教程按钮
    Button tutorialBtn("新手教程", font, 28,
